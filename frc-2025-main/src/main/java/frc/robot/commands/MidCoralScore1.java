...
public class MidCoralScore1 extends SequentialCommandGroup { 
    private CoralIntake s_CoralIntake;   
    private Elevator s_Elevator;
    private VisionSystem s_Vision;
    private CommandSwerveDrivetrain s_swerve;
    
    public MidCoralScore1(Elevator elevator, CoralIntake coralIntake, VisionSystem vision, CommandSwerveDrivetrain swerve){
        ...
        addCommands(
            ...
            new WaitCommand(1),
            new InstantCommand(() -> s_Elevator.midPos1()),
            new WaitCommand(1),
